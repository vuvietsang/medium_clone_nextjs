...
function Post({ post }: Props) {
  ...
  const handleSubmitt: SubmitHandler<FromInput> = async (values) => {
  ...
  return (
    <main>
          ...
          <PortableText
            ...
            serializers={{
              ...
              link: ({ href, children }: any) => (
                <a className="my-5 text-xl font-bold" href={href}>
                  {children}
                </a>
              ),
            }}
      ...
      <div className="my-10 mx-auto flex max-w-3xl flex-col p-10 shadow shadow-yellow-300">
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, //afer 60s update data from API
  }
}
